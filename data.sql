...
create table gtfs_agency (
  ...
  agency_phone text
--, fare_url text
) AS SELECT * FROM CSVREAD('resources/agency.txt');
...
) AS SELECT * FROM CSVREAD('resources/stops.txt');
...
)  AS SELECT * FROM CSVREAD('resources/routes.txt');
...
) AS SELECT * FROM CSVREAD('resources/calendar.txt');
...
) AS SELECT * FROM CSVREAD('resources/trips.txt');
...
) AS SELECT * FROM CSVREAD('resources/stop_times.txt');
