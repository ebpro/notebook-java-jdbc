...
create table gtfs_agency (
  ...
  agency_phone text
--, fare_url text
) AS SELECT * FROM CSVREAD('/notebooks/resources/agency.txt');
...
) AS SELECT * FROM CSVREAD('/notebooks/resources/stops.txt');
...
)  AS SELECT * FROM CSVREAD('/notebooks/resources/routes.txt');
...
) AS SELECT * FROM CSVREAD('/notebooks/resources/calendar.txt');
...
) AS SELECT * FROM CSVREAD('/notebooks/resources/trips.txt');
...
) AS SELECT * FROM CSVREAD('/notebooks/resources/stop_times.txt');
